...
LIE.journeys['optimization-gd'] = (function(){
  ...
  return {
    ...
    cards: {
      hu: [
        {t:'A völgy', b:'<p>Minimalizáljuk a</p><p class="matline"><span class="m">L(w) = <span class="frac"><span>1</span><span>2</span></span> w<sup>⊤</sup>Q w,&nbsp;&nbsp;Q =</span><span class="matrix"><span class="mbracket"></span><span class="mgrid" style="grid-template-columns:repeat(2,auto)"><span>0.64</span><span>0</span><span>0</span><span>0.64</span></span><span class="mbracket right"></span></span></p><p><button class="termbtn" id="ogQuadInfo" type="button" aria-expanded="false" aria-controls="ogQuadNote">kvadratikus</button> völgyet a lapos <span class="m">w ∈ ℝ<sup>2</sup></span> fölött. A borostyán gömb a jelenlegi <span class="m">w</span>, a zöld pont a minimum (<span class="m">w<sub>*</sub> = 0</span>). Ugyanez a legkisebb négyzetek völgye is, ahol <span class="m">Q = A<sup>⊤</sup>A</span>. Sokaság nincs — minden a lapos <span class="m">ℝ<sup>2</sup></span>-ben történik.</p><div class="bubble" id="ogQuadNote" role="dialog" aria-label="Miert negyzetes alak" hidden><p>Skalár eset: egy változóra a völgy <span class="m">L(w) = <span class="frac"><span>1</span><span>2</span></span> q w<sup>2</sup></span>, a deriváltja <span class="m">q w</span>.</p><p>Több változóra a <span class="m">w<sup>2</sup></span> helyére a <span class="m">w<sup>⊤</sup>Q w</span> lép — ez a <em>négyzetes alak</em>:</p><p class="matline"><span class="m">w<sup>⊤</sup>Q w = Σ<sub>i,j</sub> w<sub>i</sub> Q<sub>ij</sub> w<sub>j</sub></span></p><p>A mi <span class="m">Q = 0.64·I</span> mátrixunkkal csak az átlós tagok maradnak, <span class="m">0.64 (w<sub>1</sub><sup>2</sup> + w<sub>2</sub><sup>2</sup>)</span>. A derivált a skalár <span class="m">q w</span> mátrixos párja: <span class="m">∇L = Q w</span>.</p></div>'},
      ...
      ja: [
        {t:'谷', b:'<p>最小化するのは</p><p class="matline"><span class="m">L(w) = <span class="frac"><span>1</span><span>2</span></span> w<sup>⊤</sup>Q w,&nbsp;&nbsp;Q =</span><span class="matrix"><span class="mbracket"></span><span class="mgrid" style="grid-template-columns:repeat(2,auto)"><span>0.64</span><span>0</span><span>0</span><span>0.64</span></span><span class="mbracket right"></span></span></p><p>という、平坦な <span class="m">w ∈ ℝ<sup>2</sup></span> の上の<button class="termbtn" id="ogQuadInfo" type="button" aria-expanded="false" aria-controls="ogQuadNote">二次</button>の谷です。琥珀色の球が現在の <span class="m">w</span>、緑の点が最小値（<span class="m">w<sub>*</sub> = 0</span>）。これは最小二乗法の谷でもあり、そのとき <span class="m">Q = A<sup>⊤</sup>A</span> です。多様体はありません — すべては平坦な <span class="m">ℝ<sup>2</sup></span> の中で起こります。</p><div class="bubble" id="ogQuadNote" role="dialog" aria-label="なぜ二次形式か" hidden><p>スカラーの場合: 変数が一つなら谷は <span class="m">L(w) = <span class="frac"><span>1</span><span>2</span></span> q w<sup>2</sup></span>、その微分は <span class="m">q w</span> です。</p><p>変数が増えると <span class="m">w<sup>2</sup></span> の代わりに <span class="m">w<sup>⊤</sup>Q w</span> が来ます — これが<em>二次形式</em>です:</p><p class="matline"><span class="m">w<sup>⊤</sup>Q w = Σ<sub>i,j</sub> w<sub>i</sub> Q<sub>ij</sub> w<sub>j</sub></span></p><p>ここでの <span class="m">Q = 0.64·I</span> では対角項だけが残り、<span class="m">0.64 (w<sub>1</sub><sup>2</sup> + w<sub>2</sub><sup>2</sup>)</span> になります。微分はスカラーの <span class="m">q w</span> の行列版: <span class="m">∇L = Q w</span>。</p></div>'},
