...
LIE.journeys['slam-pipeline'] = (function(){
  ...
  return {
    ...
    seq: { next: null, requires: ['geometry-se3', 'slam-factor-graph'], handoffs: ['geometry-se3', 'geometry-so3', 'so3-optimization', 'slam-factor-graph'] },
    build,
    cards: {
      hu: [
