...
LIE.journeys['slam-factor-graph'] = (function(){
  ...
  function build(C, PAL){
    ...
    const stations = [
      ...
      g=>{
        const gr = graph(g, 1.0, 0, -0.1);
        const lbl = makeLabel('Σ ½ r^{⊤} Σ^{−1} r', HX.amber, 4.0); lbl.position.set(0, 3.15, 0); g.add(lbl);
