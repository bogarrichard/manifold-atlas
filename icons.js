...
LIE.icons = (function(){
  ...
  const S = body => '<svg class="svgic" viewBox="0 0 24 24" aria-hidden="true" focusable="false" '+
  ...
  const F = body => '<svg class="svgic" viewBox="0 0 24 24" aria-hidden="true" focusable="false" '+
  ...
  return {
    ...
    themeSystem: S('<circle cx="12" cy="12" r="8.5"/>' +
      '<path d="M12 3.5a8.5 8.5 0 0 1 0 17z" fill="currentColor" stroke="none"/>'),
    themeLight: S('<circle cx="12" cy="12" r="4.2"/>' +
      p('M12 2.5v2.2M12 19.3v2.2M4.28 4.28l1.56 1.56M18.16 18.16l1.56 1.56' +
    ...
    speechOn: S(p('M11 5L6.5 9H3.5v6h3L11 19z') +
      p('M14.8 9.4a3.6 3.6 0 0 1 0 5.2') + p('M17.6 6.8a7.4 7.4 0 0 1 0 10.4')),
    speechOff: S(p('M11 5L6.5 9H3.5v6h3L11 19z') +
      p('M15.5 10l4.5 4') + p('M20 10l-4.5 4')),
