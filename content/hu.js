...
window.LIE_CONTENT.hu = {
    ...
    branches: {
      geometry: { title: 'Geometria', summary: '<p>A terek, amikben a dolgok élnek — forgatások, pózok, hasonlóságok — és ahogy mozognak. Hat utazás a lapos ℝ<sup>n</sup>-től a Sim(3)-ig: érintőterek, exp/log, és (az SO(3)-nál) topológia. Költségfüggvény sehol.</p>',
        moons: {
          ...
          so3: { title: 'SO(3) — forgatások 3D-ben', summary: '<p>A tér, ami az egész elméletet indokolja. Nem-kommutatív, kompakt, és a valódi alakja nem gömb, hanem ℝP<sup>3</sup>.</p><p>Itt van a lehetetlenségi tétel is: nincs globális, szingularitásmentes háromszámos koordináta — a gimbal lock nem bosszúság, hanem következmény.</p>' },
      ...
      optimization: { title: 'Optimalizálás', summary: '<p>Ahogy egy költséget minimalizálunk: gradiens-módszer, majd Gauss–Newton, majd a gyakorlati változatok. Mindez elfér a lapos ℝ<sup>n</sup>-ben — sokaság nem kell hozzá.</p>',
        moons: {
          gd: { title: 'Gradiens-módszer', summary: '<p>A völgy, a gradiens és az iteráció — végig lapos ℝ<sup>2</sup>-ben, zárt alakban végigszámolva.</p><p>Ez az a motor, amit a Riemann-gradiens majd a görbült SO(3)-ra emel. Előbb lássuk működni ott, ahol semmi nem bonyolítja.</p>' },
  ...
  cards: [
   ...
   {t:'SE(3) — póz az időben', b:'<p>Forgatás + eltolás = póz: 6 szabadsági fok, egy mozgó referenciakeret a pályán. A <span class="m">⊞</span> ugyanez a recept, csak a tangenstér <span class="m">ℝ<sup>6</sup></span>: három szög, három eltolás.</p><p>A pózok saját fejezetet kaptak: a <em>Geometry · SE(3)</em> utazása tíz állomáson viszi végig — a láncolás, a sorrend, a csavarmozgás, a bal Jacobi, az adjungált és az interpoláció.</p><p>Innen indul a SLAM: sok ilyen póz faktorokkal összekötve, és rajtuk fut az előző állomás iterációja.</p>'}
  ]
};
