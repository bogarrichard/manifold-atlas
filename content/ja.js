...
window.LIE_CONTENT.ja = {
  ...
  hub: {
    ...
    intro: '<p>ようこそ。中心の座標系のまわりを一つの惑星系が回り、それぞれの惑星には順に降り立てる世界が連なっています。まずは<b>幾何</b>と<b>最適化</b>から始め、その軌道が交わる場所をたどってください — 本当の見返りはそこから始まります。</p><p>惑星にマウスを乗せると何を抱えているかが見え、クリックすると近づいて、衛星のリングがカルーセルに並びます。<b>← →</b> で次の目的地へ回し、選んだ衛星の概要がここに出ます。手前の衛星をクリックすると着陸、<b>↑</b> で地図に戻ります。</p><p>明るい球はすでに開いていて、淡いものはまだ測量中です。</p>',
    hint: ['ドラッグ: 回転', 'スクロール: ズーム', '惑星をクリック', '← → : 衛星リング'],
    moonWord: '目的地',
    branches: {
